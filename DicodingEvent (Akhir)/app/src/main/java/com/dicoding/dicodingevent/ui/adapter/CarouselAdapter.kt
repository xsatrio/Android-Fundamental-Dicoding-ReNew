...
import com.dicoding.dicodingevent.databinding.ItemCarouselBinding

class CarouselAdapter(private val onItemClick: (Int) -> Unit) :
    ListAdapter<EventActiveEntity, CarouselAdapter.EventViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: EventViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            Log.d("CarouselAdapter", "Item clicked: ${event.id}")
            onItemClick(event.id)
        }
    }

    class EventViewHolder(private val binding: ItemCarouselBinding) :
